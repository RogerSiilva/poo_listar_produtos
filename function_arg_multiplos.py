...
def listar_produtos(*listas): 
    ...
    for lista in listas: -> percorre as listas que estão dentro das tuplas
        for produto, estoque in lista: -> percorre produto Ex: 'BSA2199', estoque Ex: '396' dentro da lista
            lista_produtos.append(produto) -> Adiciona na lista vazia criada no inicio da function
    lista_produtos = set(lista_produtos) -> A funcao SET retira os valores duplicados, tonando unicos
    lista_produtos = list(lista_produtos) -> Apos o SET, cria-se uma nova lista
    return lista_produtos -> retorna o resultado da function
'''
